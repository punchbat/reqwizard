...
import { FilterInput, useGetTicketResponsesByUserIDQuery } from "@app/services/ticket_response";
...
const MyTicketResponses: FC = function () {
    ...
    const { data, isLoading, refetch } = useGetTicketResponsesByUserIDQuery({
        search,
