...
import { Input, Typography, Spin, Button, Select, DatePicker, TimeRangePickerProps } from "antd";
import { useNavigate, useLocation } from "react-router-dom";

import { cn } from "@utils";
import { FilterInput, useGetMyListQuery } from "@app/services/applicaiton";
...
const Home: FC = function () {
    ...
    const { data, isLoading, refetch } = useGetMyListQuery({
        search,
        statuses,
        types,
        subTypes,
